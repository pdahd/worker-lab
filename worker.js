// worker.js — v2.1 (compact single-file)
...
body{
  ...
  margin:0;padding:16px;background:#e7d9c4;color:#222;
}
main{
  max-width:920px;margin:24px auto;border-radius:20px;
  background:
    linear-gradient(90deg,rgba(255,255,255,0.25),rgba(0,0,0,0.05)),
    repeating-linear-gradient(90deg,rgba(255,255,255,0.18)0,rgba(255,255,255,0.18)1px,rgba(0,0,0,0.06)2px,rgba(0,0,0,0.06)3px),
  ...
  box-shadow:0 18px 40px rgba(0,0,0,0.35),0 4px 10px rgba(0,0,0,0.18),
             inset 0 1px 2px rgba(255,255,255,0.7),inset 0 -1px 3px rgba(0,0,0,0.15);
  border:1px solid rgba(255,255,255,0.65);backdrop-filter:blur(6px);
}
main::after{
...
main.sweep-active::before{
  opacity:1;animation:sweep 3.5s ease-in-out infinite;
}
@keyframes sweep{
  0%{left:-120%;}
  45%{left:140%;}
...
h1{color:#222;text-shadow:0 1px 2px rgba(255,255,255,0.7);margin-top:0;}
.small{color:#555;}
textarea{
  width:100%;padding:12px 14px;font-size:14px;box-sizing:border-box;border-radius:14px;
  background:radial-gradient(circle at top left,rgba(255,255,255,0.7),rgba(255,245,225,0.4));
  background-color:rgba(255,245,225,0.4);backdrop-filter:blur(8px);
  border:1px solid rgba(255,255,255,0.8);
  box-shadow:inset 0 1px 2px rgba(255,255,255,0.9),
             inset 0 -1px 3px rgba(0,0,0,0.18),
             0 2px 6px rgba(0,0,0,0.18);
  color:#333;transition:border-color .2s,box-shadow .2s,background .2s;
}
textarea:focus{
  border-color:#5ab0ff;
...
select,input{
  ...
  background:#ffffffdd;color:#222;backdrop-filter:blur(4px);
  transition:border-color .2s,box-shadow .2s;
}
select:focus,input:focus{
  border-color:#4da3ff;box-shadow:0 0 0 1px rgba(77,163,255,0.4);
}
button{
  padding:10px 18px;border-radius:10px;border:1px solid rgba(90,176,255,0.9);
...
button:hover{
  ...
  box-shadow:0 0 0 1px rgba(120,196,255,0.9),
...
button:active{
  ...
  box-shadow:0 0 0 1px rgba(140,210,255,1),
             0 3px 8px rgba(0,0,0,0.4),
             0 0 14px rgba(140,210,255,0.9);
}
button:disabled{
  background:#777;border-color:#777;cursor:not-allowed;box-shadow:none;
}
img{
  max-width:100%;border-radius:10px;margin-top:16px;display:none;
